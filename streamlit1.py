...
domains_df = pd.read_csv('C:/Users/addisu/Documents/GitHub/news_correlation_10ac_week0/data.csv/domains_location.csv')
traffic_df = pd.read_csv('C:/Users/addisu/Documents/GitHub/news_correlation_10ac_week0/traffic_data/traffic.csv')

# Create a Streamlit dashboard
st.title('Data Dashboard')

# Display the data using Streamlit components
st.write('Top 5 rows of Rating Data:')
st.write(data_df.head())

st.write('Top 5 rows of Domains Location Data:')
st.write(domains_df.head())

st.write('Top 5 rows ofTraffic Data:')
st.write(traffic_df.head())




# # Top 10 websites by Global Rank
# highest_traffic_websites = traffic_df.nlargest(10, 'GlobalRank')
...
largest_websites = data_df['source_name'].value_counts().nlargest(10)
...
highest_news_media_organisations = domains_df['Country'].value_counts().nlargest(10)

# Plot the count of news media organizations for each country
plt.figure(figsize=(10, 6))
highest_news_media_organisations.plot(kind='bar', color='lightcoral')
plt.title('Top 10 Countries by Number of News Media Organizations')
plt.xlabel('Country')
